          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 lg:items-center">
            ...
            <div>
              ...
              <ul className="mt-6 space-y-4 text-gray-700">
                <li className="flex gap-3"><span className="text-syntech-green font-bold">✓</span> Practice on your schedule—no drive to the course</li>
                <li className="flex gap-3"><span className="text-syntech-green font-bold">✓</span> True roll and speed options to match your game</li>
                <li className="flex gap-3"><span className="text-syntech-green font-bold">✓</span> Custom size, shape, and contour to fit your space</li>
                <li className="flex gap-3"><span className="text-syntech-green font-bold">✓</span> Low maintenance—no watering or mowing</li>
                <li className="flex gap-3"><span className="text-syntech-green font-bold">✓</span> Adds value and appeal to your property</li>
              </ul>
            </div>
          </div>
        </div>
