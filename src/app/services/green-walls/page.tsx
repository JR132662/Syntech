          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 lg:items-center">
            ...
            <div>
              ...
              <ul className="mt-6 space-y-4 text-gray-700 dark:text-gray-300">
                <li className="flex gap-3"><span className="text-syntech-green dark:text-syntech-green-light font-bold">✓</span> Instant impact—dramatic look for commercial and residential</li>
                <li className="flex gap-3"><span className="text-syntech-green dark:text-syntech-green-light font-bold">✓</span> Low maintenance compared to living plants</li>
                <li className="flex gap-3"><span className="text-syntech-green dark:text-syntech-green-light font-bold">✓</span> Works indoors and outdoors, any climate</li>
                <li className="flex gap-3"><span className="text-syntech-green dark:text-syntech-green-light font-bold">✓</span> Custom sizes and designs to fit your space</li>
                <li className="flex gap-3"><span className="text-syntech-green dark:text-syntech-green-light font-bold">✓</span> Ideal for offices, hotels, retail, and homes</li>
              </ul>
            </div>
          </div>
        </div>
